    ...
    public class DataContext : DbContext
    {
        ...
        private static void SeedProductData(ModelBuilder modelBuilder)
        {
            var list = new List<Product>{
                ...
                new Product{ProductId = 25, ProductName="Liqui Moly A/C cleaner KLIMA-ANLAGEN-REINIGER 2K (Chai xịt bảo vệ nội thất) 5l",
                ...
                new Product{ProductId = 30, ProductName="3M Diesel fuel tank additive (Vệ Sinh Kim Phun Buồng Đốt) 250ml",
                    ProductImage="https://lzd-img-global.slatic.net/g/p/7eb37a7842b5f088a515447575ecdeac.jpg_720x720q80.jpg_.webp",
                    ProductUnit=ProductUnit.Bottle, ProductPrice=180, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 0,
                    ServiceId=12, CategoryId=1},
                
                new Product{ProductId = 31, ProductName="3M Throttle Plate & Carb Cleaner (Vệ sinh bướm ga) 241ml",
                ...
                new Product{ProductId = 32, ProductName="Botny Carburetor Cleaner (Bình xịt vệ sinh van EGR) 450g",
                ...
                new Product{ProductId = 33, ProductName="Senfineco Brake & Part Cleaner (Chai xịt vệ sinh thắng) 600ml",
                ...
                new Product{ProductId = 34, ProductName="Johnsen's Brake Cleaner (Chai xịt vệ sinh thắng) 397g",
                ...
                new Product{ProductId = 35, ProductName="NS2 Conditioning Cleaner (Dung dịch nội soi vệ sinh giàn lạnh) 250ml",
                    ProductImage="https://tahico.com/wp-content/uploads/2022/03/dung-dich-cho-may-noi-soi-ve-sinh-gian-lanh-dieu-hoa.jpg",
                    ProductUnit=ProductUnit.Bottle, ProductPrice=150, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 0,
                    ServiceId=15, CategoryId=1},
                
                new Product{ProductId = 36, ProductName="Ultra Glaco (Chai phủ Nano ô tô) 150g",
                ...
                new Product{ProductId = 37, ProductName="Crystal coating (Bộ phủ Ceramic 9H) 30ml",
                ...
                new Product{ProductId = 38, ProductName="Crystal coating (Bộ phủ Ceramic 9H) 30ml",
                    ProductImage="https://down-vn.img.susercontent.com/file/9d15f0c731a5ed75720349e14510b984",
                    ProductUnit=ProductUnit.Bottle, ProductPrice=750, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 0,
                    ServiceId=17, CategoryId=1},
                
                new Product{ProductId = 39, ProductName="Crystal coating (Bộ phủ Ceramic 9H) 40ml",
                    ProductImage="https://down-vn.img.susercontent.com/file/9d15f0c731a5ed75720349e14510b984",
                    ProductUnit=ProductUnit.Bottle, ProductPrice=1000, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 0,
                    ServiceId=17, CategoryId=1},
                
                new Product{ProductId = 40, ProductName="Onzca P991 (Sơn phun phủ gầm ô tô) 1l",
                ...
                new Product{ProductId = 41, ProductName="Aikka 2002 (Sơn phủ gầm) 1l",
                ...
                new Product{ProductId = 42, ProductName="Onzca P993 (Sơn phun phủ gầm ô tô) 1.5l",
                ...
                new Product{ProductId = 43, ProductName="Forch L 260 (Sơn phun phủ gầm ô tô) 1l",
                ...
                new Product{ProductId = 44, ProductName="Dán phim cách nhiệt Nano Ceramics 4 chỗ cơ bản",
                ...
                new Product{ProductId = 45, ProductName="Dán phim cách nhiệt Nano Ceramics 7 chỗ cơ bản",
                    ProductImage="https://tuananhauto.vn/wp-content/uploads/2019/11/film-nanoceramics-600x291.png",
                    ProductUnit=ProductUnit.Film, ProductPrice=4400, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 120,
                    ServiceId=20, CategoryId=1},

                new Product{ProductId = 46, ProductName="Dán phim cách nhiệt Nano Ceramics 4 chỗ cao cấp",
                    ProductImage="https://tuananhauto.vn/wp-content/uploads/2019/11/film-nanoceramics-600x291.png",
                    ProductUnit=ProductUnit.Film, ProductPrice=5000, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 120,
                    ServiceId=21, CategoryId=2},
                
                new Product{ProductId = 47, ProductName="Dán phim cách nhiệt Nano Ceramics 7 chỗ cao cấp",
                    ProductImage="https://tuananhauto.vn/wp-content/uploads/2019/11/film-nanoceramics-600x291.png",
                    ProductUnit=ProductUnit.Film, ProductPrice=5600, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 120,
                    ServiceId=21, CategoryId=2},
                
                new Product{ProductId = 48, ProductName="Phim cách nhiệt 3M IR Series 4 kính sườn",
                ...
                new Product{ProductId = 49, ProductName="Phim cách nhiệt 3M IR Series 5 kính sườn",
                    ProductImage="https://akauto.com.vn/wp-content/uploads/2022/09/phim-cach-nhiet-3M-IR-Series.jpg",
                    ProductUnit=ProductUnit.Film, ProductPrice=4000, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 120,
                    ServiceId=22, CategoryId=1},
                
                new Product{ProductId = 50, ProductName="Phim cách nhiệt 3M IR Series 6 kính sườn",
                    ProductImage="https://akauto.com.vn/wp-content/uploads/2022/09/phim-cach-nhiet-3M-IR-Series.jpg",
                    ProductUnit=ProductUnit.Film, ProductPrice=4700, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 120,
                    ServiceId=22, CategoryId=1},
                
                new Product{ProductId = 51, ProductName="Phim cách nhiệt 3M Crystalline 4 kính sườn",
                    ...
                    ProductWarrantyPeriod = 144,
                    ServiceId=23, CategoryId=2},
                
                new Product{ProductId = 52, ProductName="Phim cách nhiệt 3M Crystalline 5 kính sườn",
                    ProductImage="https://akauto.com.vn/wp-content/uploads/2022/09/phim-cach-nhiet-3M-Crystalline.jpg",
                    ProductUnit=ProductUnit.Film, ProductPrice=8000, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 144,
                    ServiceId=23, CategoryId=2},
                
                new Product{ProductId = 53, ProductName="Phim cách nhiệt 3M Crystalline 6 kính sườn",
                    ProductImage="https://akauto.com.vn/wp-content/uploads/2022/09/phim-cach-nhiet-3M-Crystalline.jpg",
                    ProductUnit=ProductUnit.Film, ProductPrice=9200, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 144,
                    ServiceId=23, CategoryId=2},
                
                new Product{ProductId = 54, ProductName="Lọc động cơ Hyundai Sorento",
                ...
                new Product{ProductId = 55, ProductName="Lọc động cơ Hyundai SONATA",
                ...
                new Product{ProductId = 56, ProductName="Motul 8100 X-CLEAN 5W40 (Thay dầu ô tô) 5l",
                ...
                new Product{ProductId = 57, ProductName="Bọc ghế da Simili xe Honda City",
                ...
                new Product{ProductId = 58, ProductName="Bọc ghế da Simili xe Hyundai Accent",
                    ProductImage="https://orokingauto.com/wp-content/uploads/2023/06/boc-ghe-da-simili-xe-hyundai-accent-4.jpg",
                    ProductUnit=ProductUnit.Other, ProductPrice=3500, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 0,
                    ServiceId=27, CategoryId=1},
                
                new Product{ProductId = 59, ProductName="Thảm sàn kim cương",
                ...
                new Product{ProductId = 60, ProductName="Thảm lót sàn xe ô tô Hyundai Stargazer",
                ...
                new Product{ProductId = 61, ProductName="Thảm lót cốp xe ô tô Honda CRV",
                ...
                new Product{ProductId = 62, ProductName="Lót cốp ô tô 6D",
                ...
                new Product{ProductId = 63, ProductName="Bọc trần da 5D xe Ford EcoSport",
                ...
                new Product{ProductId = 64, ProductName="Bạt phủ xe ô tô tráng nhôm phản quang",
                ...
                new Product{ProductId = 65, ProductName="Bọc ghế da Nappa xe Toyota Fortuner",
                ...
                new Product{ProductId = 66, ProductName="Bọc ghế da Nappa xe Toyota Innova",
                    ProductImage="https://orokingauto.com/wp-content/uploads/2023/05/boc-ghe-da-nappa-xe-toyota-innova-1-1-510x510.jpg",
                    ProductUnit=ProductUnit.Other, ProductPrice=14000, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 60,
                    ServiceId=31, CategoryId=1},
                
                new Product{ProductId = 67, ProductName="SpeedMap M1 (Camera hành trình)",
                ...
                new Product{ProductId = 68, ProductName="V10 plus (Camera hành trình) 3.2 inch",
                ...
                // không có sản phẩm diệt khuẩn đèn demi (ServiceId: 9)
            };
