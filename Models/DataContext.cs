    ...
    public class DataContext : DbContext
    {
        ...
        private static void SeedProductData(ModelBuilder modelBuilder)
        {
            var list = new List<Product>{
                ...
                new Product{ProductId = 34, ProductName="Phim cách nhiệt 3M IR Series 5 kính sườn",
                    ProductImage="https://akauto.com.vn/wp-content/uploads/2022/09/phim-cach-nhiet-3M-IR-Series.jpg",
                    ProductUnit=ProductUnit.Film, ProductPrice=4000, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 60,
                    ServiceId=22, CategoryId=1},
                
                new Product{ProductId = 35, ProductName="Phim cách nhiệt 3M IR Series 6 kính sườn",
                    ProductImage="https://akauto.com.vn/wp-content/uploads/2022/09/phim-cach-nhiet-3M-IR-Series.jpg",
                    ProductUnit=ProductUnit.Film, ProductPrice=4700, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 60,
                    ServiceId=22, CategoryId=1},
                
                new Product{ProductId = 36, ProductName="Phim cách nhiệt 3M Crystalline 4 kính sườn",
                ...
                new Product{ProductId = 37, ProductName="Phim cách nhiệt 3M Crystalline 5 kính sườn",
                    ProductImage="https://akauto.com.vn/wp-content/uploads/2022/09/phim-cach-nhiet-3M-Crystalline.jpg",
                    ProductUnit=ProductUnit.Film, ProductPrice=8000, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 120,
                    ServiceId=23, CategoryId=2},
                
                new Product{ProductId = 38, ProductName="Phim cách nhiệt 3M Crystalline 6 kính sườn",
                    ProductImage="https://akauto.com.vn/wp-content/uploads/2022/09/phim-cach-nhiet-3M-Crystalline.jpg",
                    ProductUnit=ProductUnit.Film, ProductPrice=9200, ProductStatus=Status.Activate, 
                    ProductWarrantyPeriod = 120,
                    ServiceId=23, CategoryId=2},
                
                new Product{ProductId = 39, ProductName="Lọc động cơ Hyundai Sorento",
                ...
                new Product{ProductId = 40, ProductName="Lọc động cơ Hyundai SONATA",
                ...
                new Product{ProductId = 41, ProductName="Motul 8100 X-CLEAN 5W40 (Thay dầu ô tô) 5l",
                ...
                new Product{ProductId = 44, ProductName="Thảm sàn kim cương",
                ...
                new Product{ProductId = 46, ProductName="Thảm lót cốp xe ô tô Honda CRV",
                ...
                new Product{ProductId = 47, ProductName="Lót cốp ô tô 6D",
                ...
                new Product{ProductId = 53, ProductName="V10 plus (Camera hành trình) 3.2 inch",
