...
namespace GraduationThesis_CarServices.Repositories.IRepository
{
    public interface IWorkingScheduleRepository
    {
        ...
        Task<List<WorkingSchedule>?> FilterWorkingScheduleByGarage(int garageId, string daysOfTheWeek);
        Task<List<WorkingSchedule>?> FilterWorkingScheduleByMechanic(int mechanicId);
        Task<List<WorkingSchedule>?> FilterWorkingScheduleWhoAvailable(int garageId, string daysOfTheWeek);
